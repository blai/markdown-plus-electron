...
class EditorWindow {
    ...
    setButtonClick() {
        ...
        $('#editor-controll-chart-pie').click(event, () => {
        ...
        $('#editor-controll-chart-bubble').click(event, () => {
    ...
    resizeEditor() {
        $('.editor-markdown').css('height', String($(window).height() - parseInt($('.editor-controll').css('height'), 10)) + 'px');
    }
